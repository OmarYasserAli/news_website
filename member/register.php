...
<center>
<form action="reg_p.php" method="POST" id="reg" />

<table>
<tr>  <td>username</td>       <td><input type="text" name="username" id="inp"/></td>  </tr>
<tr>  <td>E-mail</td>       <td><input type="text" name="email" id="inp"/></td>  </tr>
<tr>  <td>Password</td>       <td><input type="password" name="password" id="inp"/></td>  </tr>
<tr>  <td>re-type pass</td>       <td><input type="password" name="rpassword" id="inp"/></td>  </tr>
</table>
